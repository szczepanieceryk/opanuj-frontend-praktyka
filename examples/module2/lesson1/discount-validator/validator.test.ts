...
describe('Form validation', () => {
  ...
  test('should return error if first name is shorter than 1 character', () => {
    const errors = formValidator('', 'Doe', 30);
  ...
  test('should return error if last name is shorter than 1 character', () => {
    const errors = formValidator('John', '', 30);
  ...
  test('should throw an error if age is not a number', () => {
    expect(() => formValidator('John', 'Doe', '30')).toThrowError();
  });

  test('should be successfully validated', () => {
